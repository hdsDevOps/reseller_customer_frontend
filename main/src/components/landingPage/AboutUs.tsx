...
const AboutUs = ({aboutUs, id}:any) => {
  ...
  return (
    <section className="max-w-screen-2xl mx-auto bg-top bg-cover" style={{ backgroundImage: `url("https://firebasestorage.googleapis.com/v0/b/dev-hds-gworkspace.firebasestorage.app/o/AboutUsSpiral.png?alt=media&token=9059dd40-366f-4bb2-96fd-92914d35ee49")` }} id={id}>
