...
const ProductivityAndCollaboration = ({plans, handleAddToCart}:any) => {
                                        ...
                                        <button type="button" onClick={(e) => {
                                            if(userDetails?.workspace) {
                                                if(userDetails?.workspace?.workspace_status === "trial") {
                                                    toast.error("You cannot update your plan during trial period");
                                                } else {
                                                    handleAddToCart(e, plan, "Yearly", null);
                                                }
                                            } else {
                                                navigate('/subscribe-plan', { state: {plan, period: 'Yearly', from: 'dashboard'} });
                                            }
                                        }} className="font-inter font-semibold sm:text-base text-xs text-[#F0F0F3] bg-[#12A833] sm:px-3 px-2 sm:py-2 py-[2px] sm:rounded-[10px] rounded-[4px] max-w-[126px] mt-1">
                                            {
