...
const FrequentlyAskedQuestions = () => {
  ...
  return (
    <section className="sm:px-16 px-4 w-full mt-10 bg-cover bg-top flex flex-col" style={{ backgroundImage: `url("https://firebasestorage.googleapis.com/v0/b/dev-hds-gworkspace.firebasestorage.app/o/AboutUsSpiral.png?alt=media&token=9059dd40-366f-4bb2-96fd-92914d35ee49")` }}>
      <div className="mb-2">
