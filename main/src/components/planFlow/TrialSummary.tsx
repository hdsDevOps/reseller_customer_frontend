  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-lg p-6 border border-gray-300 rounded-xl bg-white mt-4">
        ...
        <button className="w-full bg-green-600 text-white py-2 px-4 rounded-lg" onClick={()=>navigate('/gemini-summary', { state: { ...location.state, plan: plan, } })} cypress-name="trial-summary-button">
          Start Free Trial
        </button>
      </div>
    </div>
